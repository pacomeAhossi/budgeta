...
export default function Button({
    ...
    const baseClasses = 'inline-flex justify-center px-6 py-3 rounded-[50px] font-bold';
    // Classe selon la variante
    const variantClasses = {
        primary: 'bg-budgeta-green font-base text-black hover:bg-budgeta-green/90',
        secondary: 'bg-bark text-white border-2 border-white hover:bg-white hover:text-black'
    }
